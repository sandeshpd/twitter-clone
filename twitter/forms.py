...
# TODO: Add placeholder instead of label
# class MDOutlinedTextField(forms.Widget):
#     template_name = 'md_outlined_text_field.html'

#     def render(self, name, value, attrs=None, renderer=None):
#         html = f'''
#         <md-outlined-text-field placeholder="{attrs.get('placeholder', '')}">
#             <input id="{attrs.get('id', name)}" name="{name}" value="{value or ''}" type="{attrs.get('type', 'text')}">
#         </md-outlined-text-field>
#         '''
#         return mark_safe(html)

# User Signup form
# FIXME: User entered data do not get stored in DB and SignUp page keep redirecting to itself
class SignUpForm(UserCreationForm):
    ...
    # TODO: Define password1 and password2 here, not in class Meta
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['password2'].widget.attrs['class'] = 'md-text-field__input'
        # self.fields['password2'].widget.attrs['placeholder'] = 'Confirm password'
        # self.fields['password2'].label = 'Confirm your password'
        # self.fields['password1'].type = 'password'
